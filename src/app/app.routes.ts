...
import { RegistermainComponent } from './components/register-main/register-main';
...
import { TeacherRegisterComponent } from './components/teacher-register/teacher-register';
...
import { LoginStudent } from './components/login-student/login-student';
import { LoginTeacher } from './components/login-teacher/login-teacher';
